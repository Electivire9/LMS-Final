                        ...
                        <div class="card" style="width: 70%;">
                            ...
                            <div class="card-body text-center">
                                ...
                                <div class="mb-3 row">
                                    <?php
                                    if ($type == "cust") {
                                        echo "<label for='expireDate' class='col-3 col-form-label'>Expire Date:</label>";
                                        echo "<div class='col-9'>
                                                <input type='text' id='expireDate' name='expireDate' readonly class='form-control' value = '$expireDate' disabled/><br>
                                              </div>
                                    ";
                                    }
                                    ?>
