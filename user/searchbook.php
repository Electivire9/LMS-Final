                ...
                <center>
                    ...
                    <div class="container-fluid searchbar">
                        <form class="d-flex" role="search" method="post">
                            ...
                            <button class="btn btn-search" type="submit" name="submit">Search</button>
                        </form>
                    </div>
                    <br>
                    <!--search bar end-->
                    ...
                    <?php
                            ...
                            while ($row = mysqli_fetch_assoc($result)) { ?>
                                <tr>
                                    <td class="text-left align-middle"><?php echo $row["bookid"]; ?></td>
                                    <td class="text-left align-middle"><?php echo $row["isbn"]; ?></td>
                                    <td class="text-left align-middle"><?php echo $row["booktitle"]; ?></td>
                                    <td><img src="data:image/jpg; charset=utf8;base64,<?php echo base64_encode($row['images']); ?>" width="70" height="100" /></td>                                    <td class="text-left align-middle"><?php echo $row["author"]; ?></td>
                                </tr>
                            <?php $count++;
                            } ?>
                    </tbody>    
