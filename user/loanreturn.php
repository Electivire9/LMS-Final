                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table  class="table table-striped table-hover table-light" style="margin-top: 1%;">
                            ...
                            <tr>
                                <td colspan="2"><b>Return Date:&nbsp;</b><input type=text style="color:#FF0000;background:#D1EEEE;" value='<?php echo date('Y-m-d'); ?>' readonly></td>
                            </tr>    

                        </table>
                        <a href="loan.php" class="btn btn-primary">Cancel</a>
                        
                        <a href="loanupdate.php?id=<?php echo $result["recordid"]; ?>" class="btn btn-primary">Confirmation</a>
                    </div>
                </div>
